  ...
  columnDefs: [
    ...
    },
    {
      ...
      render: function (data, type, row) {
        const t1 = row.template == 1 ? "selected" : "";
        const t2 = row.template == 2 ? "selected" : "";
        const t3 = row.template == 3 ? "selected" : "";
        const t4 = row.template == 4 ? "selected" : "";
        const t5 = row.template == 5 ? "selected" : "";
    ...
    success: function (res) {
      ...
      <div class="col-md-4 mb-3 text-center">
        <div class="border rounded p-2">
          <div class="fw-bold mb-2">Template ${num}</div>
          <img src="../assets/template/template${num}.png"
               class="img-fluid"
