      ...
      <div class="pc-content">
         ...
         <div class="row">
                  ...
                  <div class="card-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                           <h6 class="mb-0">Total Pemeriksaan Hari Ini</h6>
                        </div>
                     </div>
               ...
               <div class="card">
                  <div class="card-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                           <h6 class="mb-0">Hasil Selesai</h6>
                        </div>
                     </div>
                     <div class="bg-body p-3 mt-3 rounded">
                        <div class="mt-3 row align-items-center">
               ...
               <div class="card">
                  <div class="card-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                           <h6 class="mb-0">Pending / Critical</h6>
                        </div>
                     </div>
                     <div class="bg-body p-3 mt-3 rounded">
                        <div class="mt-3 row align-items-center">
            ...
            <div class="col-lg-3">
               <div class="card">
                  <div class="card-header">
                     <h5 class="mb-0">List Pending</h5>
                  </div>
                  <div class="card-body">
                     <div class="mb-4">
                        <p class="mb-2">Order 12<span class="float-end">70%</span></p>
                           ...
                           <div class="d-flex align-items-center">
                              ...
                              <div class="flex-grow-1 mx-2">
                                 <p class="mb-0 d-grid text-start">
                                    <span class="text-truncate w-100">Order ID : 1212022</span>
                                 </p>
                              </div>
                     ...
                     <div class="d-grid mt-3">
                        <button class="btn btn-primary d-flex align-items-center justify-content-center"><i class="ti ti-eye"></i> Lihat Pending</button>
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-6 col-xl-4">
                           <div class="mt-3 d-grid">
                              <button class="btn btn-primary d-flex align-items-center justify-content-center"><i class="ti ti-plus"></i> Tambah Order</button>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="card">
                  <div class="card-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                           <h6 class="mb-0">Patalogi</h6>
                           <small class="text-muted">RSU Mitra Guray</small>
                        </div>
                        <div class="dropdown">
                           <a
                              class="avtar avtar-s btn-link-secondary dropdown-toggle arrow-none"
               ...
               <div class="card">
                     ...
                     <div
                        ...
                        <ul class="list-group list-group-flush">
                           <li class="list-group-item">
                              <div class="d-flex align-items-center">
                                 <div class="flex-shrink-0">
                                    <div class="avtar avtar-s border"> BD </div>
                                 </div>
                                 <div class="flex-grow-1 ms-3">
                                    <div class="row g-1">
                                       <div class="col-6">
                                       ...
                                       <div class="col-6 text-end">
                                          <h6 class="mb-1">910,000</h6>
                                          <p class="text-danger mb-0"><i class="ti ti-arrow-down-left"></i> 2 Pemeriksaan</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="card-footer">
                     <div class="row g-2">
                        <div class="col-md-6">
                           <div class="d-grid">
                              <button class="btn btn-outline-secondary d-grid"><span class="text-truncate w-100">Lihat Semua Transaksi</span></button>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="d-grid">
                              <button class="btn btn-primary d-grid"><span class="text-truncate w-100">Buat Transaksi Baru</span></button>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row g-3 mt-3">
                        <div class="col-sm-6">
                           <div class="bg-body p-3 rounded">
                              ...
                              <h6 class="mb-0">Rp. 23,876 <small class="text-muted"><i class="ti ti-chevrons-up"></i> +Rp. 763,43</small></h6>
                           </div>
                        </div>
                        <div class="col-sm-6">
                           <div class="bg-body p-3 rounded">
